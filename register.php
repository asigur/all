                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <label class="small mb-1">email</label>
                                                <input class="form-control py-4" type="text" required name="email" placeholder="jhonatan@gmail.com" />
                                            </div>
                                            <div class="form-group">
                                            <label class="small mb-1">No. Telepon</label>
                                                <input class="form-control py-4" type="text" required name="no_telepon" placeholder="08xxxxxxxxx" />
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1">Alamat</label>
                                                <textarea name="alamat" rows="2" required class="form-control"></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <label class="small mb-1" for="inputPassword">Password</label>
                                                <input class="form-control py-4" id="inputPassword" name="password" required type="password" placeholder="Masukkan password" />
                                            </div>
                                            <div class="form-group">
                                            <label class="small mb-1">level</label>
                                            <select name="level"required class="form-control">
                                            <option value="admin">Admin</option>                    
                                            <option value="peminjam">peminjam</option>   </select>                                        
                                            </div>
                                    ...
                                    <div classmard-footer text-center">
                                        <div class="small">
